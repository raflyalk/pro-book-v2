		...
		<div class="content p-24">
			...
			<div class="d-flex flex-row">
				<div class="image-overlap d-flex justify-content-center mr-24">
					<img src="<?php echo $books[$i]->volumeInfo->imageLinks->thumbnail; ?>" alt="<?php echo $books[$i]->volumeInfo->title; ?>">
				</div>
				<div class="d-flex justify-content-between w-100">
					<div class="d-flex flex-column">
						<h2 class="secondary m-0"><?php echo $books[$i]->volumeInfo->title; ?></h2>
						<p class="m-0 nowrap font-weight-light">Jumlah : <?php echo $item->quantity; ?></p>
						<p class="m-0 nowrap font-weight-light"><?php echo $item->rating == null? 'Belum direview' : 'Anda sudah memberikan review' ?></p>
					</div>
					<div class="d-flex flex-column text-right">
						<p class="m-0 nowrap font-weight-bold"><b><?php echo date("d F Y", strtotime($item->orderedBy)); ?></b></p>
						<p class="m-0 nowrap font-weight-bold"><b>Nomor Order : #<?php echo $item->id; ?></b></p>
					</div>
				</div>
			</div>
			<div class="d-flex justify-content-end mb-32">
				<?php
					if($item->rating == null) {
				?>
				<a href="/index.php/review?id=<?php echo $item->id; ?>&book-id=<?php echo $books[$i]->id; ?>" class="btn btn-primary">Review</a>
				<?php
					}
					$i++;
				?>
